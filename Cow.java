 ...
 * If the chosen square is occupied by something that is not grass or the cow 
 * would go off the grid, do nothing for that hour.
 * At any other time, the cow is asleep, and does nothing.
 * If the cow attempts to move to a square filled with grass, the grass is removed, 
 * the cow’s hungriness decreases by the amount of grass, and the cow moves to the square.
